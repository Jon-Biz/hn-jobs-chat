# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/09_chatbot/01_requirementsPrompt.ipynb.

# %% auto 0
__all__ = ['model', 'captureRequirementsPrompt', 'basePrompt', 'chain', 'config', 'requirements', 'getRequirementsResponse',
           'requirementResponse', 'handleResponse', 'handleSubmit']

# %% ../nbs/09_chatbot/01_requirementsPrompt.ipynb 1
...
# %% ../nbs/09_chatbot/01_requirementsPrompt.ipynb 2
...
# %% ../nbs/09_chatbot/01_requirementsPrompt.ipynb 3
config = {"configurable": {"session_id": "abc6"}}

# %% ../nbs/09_chatbot/01_requirementsPrompt.ipynb 4
import json
...
# %% ../nbs/09_chatbot/01_requirementsPrompt.ipynb 6
requirements = {
    'want': {},
    'donotwant': {} 
}
...
# %% ../nbs/09_chatbot/01_requirementsPrompt.ipynb 7
...
# %% ../nbs/09_chatbot/01_requirementsPrompt.ipynb 8
...
# %% ../nbs/09_chatbot/01_requirementsPrompt.ipynb 10
import json
